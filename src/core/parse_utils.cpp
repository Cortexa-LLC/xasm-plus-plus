...
// Note: Trim() removed from parse_utils.cpp - available from string_utils.h (xasm::util::Trim)
// This avoids conflicts with static Trim implementations in other modules
