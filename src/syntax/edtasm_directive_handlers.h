 ...
 */
void HandleDwDirective(const std::string &operand,
                       DirectiveContext &ctx);

/**
 * @brief Handle DS/DEFS/DSPACE/BLOCK directive - Reserve space
 */
void HandleDsDirective(const std::string &operand,
                       DirectiveContext &ctx);

/**
 * @brief Handle PUBLIC/GLOBAL/ENTRY directive - Export symbols
 */
void HandlePublicDirective(const std::string &operand,
                           DirectiveContext &ctx);

/**
 * @brief Handle EXTERN/EXTRN/EXT directive - Import symbols
 */
void HandleExternDirective(const std::string &operand,
                           DirectiveContext &ctx);
