 ...
 */
void HandleAsegDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle CSEG directive - Switch to code segment
 */
void HandleCsegDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle DSEG directive - Switch to data segment
 */
void HandleDsegDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);
 ...
 */
void HandleIfDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle ELSE directive - Else clause of conditional
 */
void HandleElseDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle ENDIF directive - End conditional block
 */
void HandleEndifDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFDEF directive - If symbol defined
 */
void HandleIfdefDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFNDEF directive - If symbol not defined
 */
void HandleIfndefDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFEQ directive - If equal
 */
void HandleIfeqDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFNE directive - If not equal
 */
void HandleIfneDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFLT directive - If less than
 */
void HandleIfltDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFGT directive - If greater than
 */
void HandleIfgtDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFLE directive - If less than or equal
 */
void HandleIfleDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFGE directive - If greater than or equal
 */
void HandleIfgeDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IF1 directive - If first pass
 */
void HandleIf1Directive(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IF2 directive - If second pass
 */
void HandleIf2Directive(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFB directive - If blank
 */
void HandleIfbDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFNB directive - If not blank
 */
void HandleIfnbDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFIDN directive - If identical
 */
void HandleIfidnDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IFDIF directive - If different
 */
void HandleIfdifDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);
 ...
 */
void HandleEndmDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle LOCAL directive - Define local symbol in macro
 */
void HandleLocalDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle EXITM directive - Exit macro early
 */
void HandleExitmDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle REPT directive - Repeat block
 */
void HandleReptDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IRP directive - Iterate over parameters
 */
void HandleIrpDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);

/**
 * @brief Handle IRPC directive - Iterate over characters
 */
void HandleIrpcDirective(const std::string &label, const std::string &operand, DirectiveContext &ctx);
