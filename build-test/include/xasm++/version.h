...
// Generated at build time from version.h.in
...
#define XASM_GIT_SHA "d78fc6d"
#define XASM_VERSION_FULL "0.9.0-d78fc6d"
...
namespace version {
    ...
    constexpr const char* version_string = XASM_VERSION_STRING;
    constexpr const char* git_sha = XASM_GIT_SHA;
