 ...
 * 
 * An atom represents a single construct in assembly language (label, instruction,
 * data, etc.). Atoms are organized in a linked list and processed during
 * multi-pass assembly. The size of an atom may change between passes as
