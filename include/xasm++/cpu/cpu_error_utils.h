 ...
 *
 * Pattern found in:
 * - cpu_6502.cpp:2253: throw std::invalid_argument("Unsupported instruction: "
 * + mnemonic);
 * - cpu_6809.cpp:1907: throw std::invalid_argument("Unsupported instruction: "
 * + mnemonic);
 *
 ...
 *
 * Pattern found in:
 * - cpu_6502.cpp:2407: throw std::invalid_argument("Special encoding not
 * supported for instruction: " + mnemonic);
 *
 ...
 *
 * Pattern found in:
 * - cpu_6502.cpp:2321: throw std::runtime_error("Expected hex value starting
 * with $");
 *
 ...
 *
 * Pattern found in:
 * - cpu_6502.cpp:2340: throw std::runtime_error("Branch target must be resolved
 * address");
 *
 * @throws std::runtime_error with message "Branch target must be resolved
 * address"
 */
 ...
 *
 * Pattern found in:
 * - cpu_6502.cpp:2376: throw std::runtime_error(mnemonic + " requires two
 * operands: srcbank,destbank");
 *
 * @param mnemonic The instruction mnemonic (e.g., "MVN")
 * @param expected_format Description of expected operand format (e.g.,
 * "srcbank,destbank")
 ...
 *
 * Pattern found in:
 * - cpu_6502.cpp:2401: throw std::runtime_error("Invalid bank values for " +
 * mnemonic + ": " + e.what());
 *
 * @param mnemonic The instruction mnemonic (e.g., "MVN")
 * @param reason Description of what's invalid (e.g., "out of range", exception
 * message)
