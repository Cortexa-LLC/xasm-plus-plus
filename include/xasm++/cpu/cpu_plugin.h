...
public:
   ...
   */
  virtual size_t GetInstructionSize(const std::string &mnemonic, // NOLINT(bugprone-easily-swappable-parameters)
   ...
   */
  virtual std::vector<uint8_t>
  EncodeInstructionSpecial(const std::string &mnemonic, // NOLINT(bugprone-easily-swappable-parameters)
