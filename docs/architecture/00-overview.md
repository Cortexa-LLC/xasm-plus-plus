...
1. **Single Responsibility Principle (SRP)**
   ...
   - Modules handle one aspect: parsing, encoding, output, analysis

2. **Open/Closed Principle (OCP)**
   - Extensible through plugins without modifying core code
   - Adding new CPU or syntax requires zero core changes

3. **Liskov Substitution Principle (LSP)**
   - All plugin implementations are fully interchangeable
   - No variant checking or special-case handling
...
5. **Dependency Inversion Principle (DIP)**
   ...
   - Plugins registered via factory pattern
...
- [vasm-ext Architecture Analysis](.ai/tasks/2026-01-19_xasm-architecture-planning/vasm-analysis.md)
- [sourcerer Architecture Analysis](.ai/tasks/2026-01-19_xasm-architecture-planning/sourcerer-analysis.md)
- [Core Abstractions](01-core-abstractions.md)
- [CPU Plugin Interface](02-cpu-plugin-interface.md)
- [Syntax Plugin Interface](03-syntax-plugin-interface.md)
- [Build System](05-build-system.md)
...
**Owner:** Bryan Woodruff / Claude Orchestrator
