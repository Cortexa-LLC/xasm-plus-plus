...
TEST(SectionTest, ConstructorCreation) {
  Section section(".data", static_cast<uint32_t>(SectionAttributes::Data),
                  0x2000);
...
TEST(SectionTest, MultipleSections) {
  Section text_section(".text", static_cast<uint32_t>(SectionAttributes::Code),
                       0x8000);
  Section data_section(".data", static_cast<uint32_t>(SectionAttributes::Data),
                       0x9000);
...
TEST(SectionTest, BitwiseAttributeFlags) {
  ...
  EXPECT_TRUE(section.attributes &
              static_cast<uint32_t>(SectionAttributes::Execute));
  EXPECT_FALSE(section.attributes &
