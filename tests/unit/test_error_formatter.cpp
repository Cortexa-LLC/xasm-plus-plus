...
TEST(ErrorFormatterTest, MultipleSuggestions) {
    ...
    if (formatted.find("PLAYER_A") != std::string::npos) suggestion_count++;
    if (formatted.find("PLAYER_B") != std::string::npos) suggestion_count++;
    if (formatted.find("PLAYER_C") != std::string::npos) suggestion_count++;
