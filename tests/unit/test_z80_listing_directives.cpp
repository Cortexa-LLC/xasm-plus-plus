...
TEST(Z80ListingDirectivesTest, TitleDirective) {
  ...
  // Add TITLE directive
  auto title = std::make_shared<ListingControlAtom>(ListingControlType::Title, "Test Program");
...
TEST(Z80ListingDirectivesTest, PageDirective) {
  ...
  // Add PAGE directive
  auto page = std::make_shared<ListingControlAtom>(ListingControlType::Page, "");
...
TEST(Z80ListingDirectivesTest, SpaceDirective) {
  ...
  auto space = std::make_shared<ListingControlAtom>(ListingControlType::Space, 3);
...
TEST(Z80ListingDirectivesTest, ListNolistDirectives) {
  ...
  auto nolist = std::make_shared<ListingControlAtom>(ListingControlType::Nolist, "");
  ...
  // Add LIST directive
  auto list = std::make_shared<ListingControlAtom>(ListingControlType::List, "");
...
TEST(Z80ListingDirectivesTest, LallSallDirectives) {
  ...
  auto lall = std::make_shared<ListingControlAtom>(ListingControlType::Lall, "");
  ...
  auto sall = std::make_shared<ListingControlAtom>(ListingControlType::Sall, "");
