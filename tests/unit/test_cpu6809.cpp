...
TEST_F(Cpu6809Test, CalculateInstructionSize_Inherent) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Inherent), 1UL);
}

TEST_F(Cpu6809Test, CalculateInstructionSize_Immediate8) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Immediate8), 2UL);
}

TEST_F(Cpu6809Test, CalculateInstructionSize_Immediate16) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Immediate16), 3UL);
}

TEST_F(Cpu6809Test, CalculateInstructionSize_Direct) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Direct), 2UL);
}

TEST_F(Cpu6809Test, CalculateInstructionSize_Extended) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Extended), 3UL);
}

TEST_F(Cpu6809Test, CalculateInstructionSize_Relative8) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Relative8), 2UL);
}

TEST_F(Cpu6809Test, CalculateInstructionSize_Relative16) {
  EXPECT_EQ(cpu.CalculateInstructionSize(AddressingMode6809::Relative16), 3UL);
}
