...
std::string CurrentFeaturesTestCaseName(
    const ::testing::TestParamInfo<BinaryCompatTestCase> &info) {
...
INSTANTIATE_TEST_SUITE_P(
    WorkingFeatures, BinaryCompatTest,
    ::testing::Values(
        ...
        // TODO: Add 03_data_directives after implementing DA, DCI, INV, FLS,
        // END
